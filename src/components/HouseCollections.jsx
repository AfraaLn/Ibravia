    ...
    <section className="py-20 bg-background text-foreground transition-colors duration-300">
      <div className="container mx-auto px-6 text-center">
        ...
        <p
          ...
          style={{ fontFamily: "var(--font-subheader)" }}
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {houses.map((house) => (
            <a
              key={house.id}
              href="#"
              className="group bg-card border border-border rounded-lg overflow-hidden shadow-sm hover:shadow-lg dark:hover:shadow-blue-500/10 transition-all duration-300 text-left block"
            >
              {/* Gambar */}
        ...
        {/* Tombol */}
        <div className="mt-12">
          <button className="px-8 py-3 rounded-md font-medium bg-primary text-primary-foreground hover:bg-primary/90 transition">
            Explore More
          </button>
        </div>
      </div>
